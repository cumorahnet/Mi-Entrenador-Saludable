...
describe('integración Android', () => {
    ...
    it('mantiene coherente la versión 2.36 en web, npm y Android', () => {
        ...
        expect(androidBuild).toContain('versionCode 236');
        expect(androidBuild).toContain('versionName "2.36"');
        expect(app).toContain('const APP_VERSION = "2.36"');
        expect(web).toContain('Versión 2.36');
    });
});

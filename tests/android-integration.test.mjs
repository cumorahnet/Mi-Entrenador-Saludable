...
describe('integración Android', () => {
    ...
    it('mantiene coherente la versión 2.35 en web, npm y Android', () => {
        ...
        expect(packageJson.version).toBe('2.35.0');
        expect(androidBuild).toContain('versionCode 235');
        expect(androidBuild).toContain('versionName "2.35"');
        expect(app).toContain('const APP_VERSION = "2.35"');
        expect(web).toContain('Versión 2.35');
    });
});

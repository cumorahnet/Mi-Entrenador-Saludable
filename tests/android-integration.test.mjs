...
describe('integración Android', () => {
    ...
    it('mantiene coherente la versión 2.39 en web, npm y Android', () => {
        ...
        expect(packageJson.version).toBe('2.39.0');
        expect(androidBuild).toContain('versionCode 239');
        expect(androidBuild).toContain('versionName "2.39"');
        expect(app).toContain('const APP_VERSION = "2.39"');
        expect(web).toContain('Versión 2.39');
    });
});
